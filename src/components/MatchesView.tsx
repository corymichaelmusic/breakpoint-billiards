                ...
                {weeks.length > 0 && (
                    <div className="flex flex-wrap gap-2 border-b border-white/10 pb-4">
                        <button
                            ...
                            className={`min-h-[44px] whitespace-nowrap rounded-lg border px-5 py-2.5 text-sm font-bold uppercase tracking-[0.14em] transition-all ${selectedWeek === 'all'
                        ...
                        {weeks.map(week => (
                            <button
                                ...
                                className={`min-h-[44px] whitespace-nowrap rounded-lg border px-5 py-2.5 text-sm font-bold uppercase tracking-[0.14em] transition-all ${selectedWeek === week
                                    ? 'border-[#D4AF37] bg-[#D4AF37] text-black shadow-[0_0_0_1px_rgba(212,175,55,0.55),0_12px_28px_rgba(212,175,55,0.22)]'
                                    : 'border-white/20 bg-[#161616] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] hover:border-[#D4AF37]/55 hover:bg-[#1d1d1d]'
                                    }`}
                            >
