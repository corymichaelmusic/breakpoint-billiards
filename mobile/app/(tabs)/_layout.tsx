        ...
        <>
            ...
            >
                ...
                <Tabs.Screen
                    ...
                    options={{
                        ...
                        tabBarIcon: () => (
                            <FontAwesome5
                                name="users"
                                size={20}
                                color={isTeamSession ? (showTeamsModal ? '#D4AF37' : '#666') : '#333'}
                            />
                        ),
                        ...
                        tabBarLabel: ({ focused }) => (
                            <View>
                                <FontAwesome5
                                    name="users"
                                    size={0} // hidden — icon above handles it
                                    color="transparent"
                                />
                            </View>
                        ),
                    ...
                    listeners={{
                        tabPress: (e) => {
                            // Always prevent navigation — show modal instead
                            e.preventDefault();
                            if (isTeamSession) setShowTeamsModal(true);
                        }
                    }}
                />
                <Tabs.Screen
            ...
            <TeamsModal visible={showTeamsModal} onClose={() => setShowTeamsModal(false)} />
        </>
    );
}
